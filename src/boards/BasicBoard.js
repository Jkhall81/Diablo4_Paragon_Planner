...
export class BasicBoard extends ParagonBoard {
  ...
  initializeTiles() {
    ...
    const tileConfigs = [
      // First Row
      { x: 3, y: 0, type: "Common Node", stats: { Willpower: 5 } },
      { x: 4, y: 0, type: "start" },
      { x: 5, y: 0, type: "Common Node", stats: { Intelligence: 5 } },

      // Second Row
      { x: 2, y: 1, type: "Common Node", stats: { Dexterity: 5 } },
      { x: 3, y: 1, type: "Common Node", stats: { Intelligence: 5 } },
      { x: 4, y: 1, type: "Common Node", stats: { Willpower: 5 } },
      ...
      // Sixth Row
      { x: 3, y: 5, type: "Common Node", stats: { Intelligence: 5 } },
      { x: 5, y: 5, type: "Common Node", stats: { Willpower: 5 } },

      // Seventh Row
      { x: 2, y: 6, type: "Common Node", stats: { Dexterity: 5 } },
      { x: 3, y: 6, type: "Common Node", stats: { Willpower: 5 } },
      { x: 4, y: 6, type: "Common Node", stats: { Dexterity: 5 } },
      { x: 5, y: 6, type: "Common Node", stats: { Intelligence: 5 } },
      { x: 6, y: 6, type: "Common Node", stats: { Willpower: 5 } },

      // Eighth Row
      { x: 1, y: 7, type: "Common Node", stats: { Willpower: 5 } },
      { x: 2, y: 7, type: "Common Node", stats: { Dexterity: 5 } },
      { x: 3, y: 7, type: "Common Node", stats: { Willpower: 5 } },
      { x: 4, y: 7, type: "Common Node", stats: { Willpower: 5 } },
      { x: 5, y: 7, type: "Common Node", stats: { Strength: 5 } },
      { x: 6, y: 7, type: "Common Node", stats: { Willpower: 5 } },
      { x: 7, y: 7, type: "Common Node", stats: { Intelligence: 5 } },
